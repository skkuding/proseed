          ...
          <div className="rounded-2xl bg-white p-6">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-body1_m_16 text-neutral-60">이메일</span>
                <span className="text-body1_m_16 text-neutral-20">proseed@gmail.com</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-body1_m_16 text-neutral-60">직무 유형</span>
                <span className="text-body1_m_16 text-neutral-20">디자이너</span>
              </div>
              <button className="flex w-full items-center justify-between transition-opacity hover:opacity-70">
                <span className="text-body1_m_16 text-neutral-60">참여 프로젝트</span>
                <div className="flex items-center gap-1">
                  <span className="text-body1_m_16 text-neutral-20">2개</span>
                  <ChevronRight className="size-4 text-neutral-40" />
                </div>
              </button>
              <button className="flex w-full items-center justify-between transition-opacity hover:opacity-70">
                <span className="text-body1_m_16 text-neutral-60">작성한 피드백</span>
                <div className="flex items-center gap-1">
                  <span className="text-body1_m_16 text-neutral-20">20개</span>
                  <ChevronRight className="size-4 text-neutral-40" />
                </div>
              </button>
            </div>

            <Button className="mt-6 h-12 w-full rounded-xl bg-neutral-10 text-white! text-sub3_sb_16 hover:bg-neutral-20">
              프로필 이미지 변경
            </Button>
          </div>
          ...
          <div className="rounded-2xl bg-white p-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-title6_m_20 text-neutral-20">내 프로필</span>
              </div>
              <ChevronRight className="size-4 text-neutral-40" />
            </button>
            <button
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-title6_m_20 text-neutral-20">계정 관리</span>
              </div>
              <ChevronRight className="size-4 text-neutral-40" />
            </button>
            <button
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-title6_m_20 text-neutral-20">FAQ · 고객센터</span>
              </div>
              <ChevronRight className="size-4 text-neutral-40" />
            </button>
          </div>
